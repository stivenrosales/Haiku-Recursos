export function Footer() {
  return (
    <footer className="bg-haiku-black text-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-12 lg:py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              ...
              <a
                href="https://elcursodelagua.substack.com/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 transition-colors"
                aria-label="Substack"
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="text-gray-400 text-sm">hola@haikubs.com</li>
              <li className="text-gray-400 text-sm">Lima, Perú</li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 text-center">
          <p className="text-gray-500 text-sm">
            &copy; 2026 Haiku Business. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
